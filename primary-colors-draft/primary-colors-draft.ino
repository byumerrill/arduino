...
//  strip.setPixelColor(0, 205, 70, 0);
//  strip.setPixelColor(1, 205, 70, 0);
//  strip.setPixelColor(2, 205, 70, 0);
//  strip.setPixelColor(3, 205, 70, 0);
    ...
    for(i=70; i<255; i++) {
      strip.fill(strip.Color(205, i, 0));
      delay(10);
    }
